...
│   │   ├── DataAugView2D.py               # Visualisation of the data augmentation transformation for 2D images
│   │   ├── DataAugView3D.py               # Visualisation of the data augmentation transformation for 3D images
...
│   │
│   ├── MultiTaskMain.py                   # The main script for the experimentation on the multi level ResNet3D
│   ├── SingleTaskMain.py                  # The main script for the experimentation on the ResNet3D
│   │
...
│   ├── MRI_image.py                       # The MRIimage class used to represent an MRI image and it ROI
│   ├── Normalize2D.py                     # Script example that create a h5py dataset of 2D normalized images
│   ├── Normalize.py                       # Script example that normalize the nifti images of a list of patient
