...
PROJECT_NAME = "march-2022-radiomics"
    ...
    if experimentation in [Experimentation.HARD_SHARING, Experimentation.LTB, Experimentation.TAG]:
        if args.aux_task_set > -1:
            if args.aux_task_set == 0:
                ...
                if args.malignancy:
                    filepath = f"Data/mal_mrmr_{num_radio}.txt"
                elif args.subtype:
                    filepath = f"Data/sub_mrmr_{num_radio}.txt"
                else:
                    filepath = f"Data/grade_mrmr_{num_radio}.txt"
            else:
